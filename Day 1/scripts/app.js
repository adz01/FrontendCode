...
function showList() {
    var myTable = '<table class="table table-striped" border="1"><tr><th>First Name</th><th>LastName</th><th>Phone</th><th>Salary</th></tr>';
...
function addEmployee() {
    ...
    function salarysum(){
        ...
        document.getElementById("salarysumid").innerHTML=sum;
    }
